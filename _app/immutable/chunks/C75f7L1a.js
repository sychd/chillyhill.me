import"./Bzak7iHL.js";import"./CiPh4DN7.js";import{f as e,a as r}from"./CHd-ugWw.js";const o={title:'Рассказ "Причина войны"',description:"Кто бы мог подумать...",date:"2025-08-25",categories:["story","writing"],published:!0,language:"ru"},{title:d,description:l,date:m,categories:u,published:c,language:g}=o;var i=e(`<p>Рука сжимала обломок спинки стула, полированное дерево приятно холодило ладонь. Джон ступал по неосвещённой квартире, водя перед собой импровизированным оружием. Бегло осмотревшись, он вернулся к входной двери и прикрыл её. После тихого щелчка Джон негромко выдохнул и опустил обломок на крохотный диванчик у входа.
...
— Похоже на то, дружище, похоже на то.</p>`);function f(t){var a=i();r(t,a)}export{f as default,o as metadata};
