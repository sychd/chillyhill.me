import{a as e,t as r}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";const d={title:'Рассказ "Даймова свобода"',description:"Антиуотпия",date:"2025-06-07",categories:["story","writing"],published:!0,language:"ru"};var o=r(`<p>Пластиковые панели, имитирующие мрамор, были затерты и облуплены. Холодное сияние голых ламп, под стать неприветливости оператора за стеклом, вытягивало последние силы. Казалось, тесное помещение было спроектировано с учётом жёсткой экономии, хотя на деле дизайн был тщательно рассчитан на создание именно такого эффекта.
