import{a as l,t as n}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";import{p as h,S as _,t as m,a as c,s as u,c as d,T as r,r as f}from"./runtime.BDZd_62D.js";import{s as b}from"./attributes.XihtgS09.js";import{i as g}from"./lifecycle.BFb_IAOa.js";import{g as D}from"./index.Bt7Az0Us.js";const T={title:'Новелла "Переживатель"',description:"Научная фантастика, триллер",date:"2024-12-1",categories:["story","writing"],published:!0,language:"ru"};var B=n(`<p>Может быть, будет удобней <a rel="nofollow">EPUB версия</a>.</p> <hr> <p>1</p> <p>Уже с месяц Мэйси была завалена работой больше обычного.	Ее макушка едва выглядывала из-за терриконов различных бумаг, что обосновались на ее рабочем столе. Из одной стопки в другую кочевали бесконечные караваны бумажных судов при помощи ее изящных рук.
...
Отныне он закончил переживать. И, наконец, начал жить.</p>`,1);function A(p,e){h(e,!1);const s=D(),[i,v]=s;g();var t=B(),a=_(t),o=u(d(a));m(()=>b(o,"href",i("https://github.com/sychd/chillyhill.me/blob/main/static/media/%D0%9F%D0%B5%D1%80%D0%B5%D0%B6%D0%B8%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8C.epub#:~:text=Raw-,View%20raw",void 0))),r(),f(a),r(74),l(p,t),c()}export{A as default,T as metadata};
