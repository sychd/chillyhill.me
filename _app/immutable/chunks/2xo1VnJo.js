import"./Bzak7iHL.js";import"./CiPh4DN7.js";import{f as o,_ as s,t as n,a as c,c as g,$ as a,r as m}from"./CHd-ugWw.js";import{s as f}from"./Cf8sFkov.js";const u=""+new URL("../assets/img.DyoVJHDb.png",import.meta.url).href,l={title:'Рассказ "Формула Гритта"',description:"Игра стоит формул",date:"2026-01-13",categories:["story","writing"],published:!0,language:"ru"},{title:b,description:P,date:v,categories:z,published:I,language:w}=l;var p=o(`<figure class="image-container"><img style="width: 450px; height: auto;" alt="Study after Velázquez's Portrait of Pope Innocent X by Francis Bacon"/> <figcaption>"Study after Velázquez's Portrait of Pope Innocent X" by Francis Bacon</figcaption></figure> Замочный механизм мерно заурчал, оттягивая засовы внутрь стены. Индикатор у биометрического зрачка моргнул зелёным, и дверь с шорохом отворилась.
...
— Ну как… — пожал плечами Гритт. Он было думал как-то развернуть свою фразу, но взгляд Шарлин показывал, что в этом нет смысла. — Колонии сбросят монопольное ярмо вонючих «Дженерал гайдлайнс» — это плюс. Но это не то, зачем я так рискую, — фиктивные зрачки безумно заблестели. — Меня заботит игра. Мне нужен азарт.`,1);function x(r){var t=p(),e=s(t),i=g(e);a(2),m(e),a(),n(()=>f(i,"src",u)),c(r,t)}export{x as default,l as metadata};
