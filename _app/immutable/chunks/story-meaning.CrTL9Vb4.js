import{a as e,t as r}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";const n={title:'Рассказ "Смысл"',description:"Когда всё трещит по швам, приходит время искать смыслы. Или терять их.",date:"2025-06-13",categories:["story","writing"],published:!0,language:"ru"};var o=r(`<p>Тяжёлым буро-оранжевым диском солнце распласталось в редких облаках. Ноздри обжигало при каждом вдохе, а ветер вместо прохлады обдавал горячими струями. Послеобеденная жара спала, но раскалённый асфальт уверенно источал жар, усиливая летнюю агонию случайных прохожих.
...
— Нет. Смысл убивать себя пропал!</p>`);function s(t){var a=o();e(t,a)}export{s as default,n as metadata};
