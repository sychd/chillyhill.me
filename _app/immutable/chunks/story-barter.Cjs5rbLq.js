import{a as r,t as e}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";const s={title:'Рассказ "Бартер"',description:"Иногда приходится что-то менять",date:"2025-09-23",categories:["story","writing"],published:!0,language:"ru"};var o=e(`<p>Мужчина средних лет с идеально уложенными волосами, в безукоризненном костюме и с переполненным гордостью взглядом стоял перед небольшой аудиторией.
...
Тонни? Да, Тонни. И я правда страсть как люблю дать перед сушей. Почему? Да какая, к чёрту, разница!</p>`);function d(t){var a=o();r(t,a)}export{d as default,s as metadata};
