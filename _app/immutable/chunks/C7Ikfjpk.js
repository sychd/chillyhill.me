import"./Bzak7iHL.js";import"./CiPh4DN7.js";import{f as e,a as r}from"./CHd-ugWw.js";const i={title:'Рассказ "Смысл"',description:"Когда всё трещит по швам, приходит время искать смыслы. Или терять их.",date:"2025-06-13",categories:["story","writing"],published:!0,language:"ru"},{title:d,description:m,date:g,categories:l,published:u,language:c}=i;var o=e(`<p>Ноздри обжигало при каждом вдохе, а ветер вместо прохлады обдавал горячими струями. Послеобеденная жара спала, но раскалённый асфальт уверенно источал жар, усиливая летнюю агонию случайных прохожих.
...
— Нет. Смысл убивать себя пропал!</p>`);function f(t){var a=o();r(t,a)}export{f as default,i as metadata};
