import{a as e,t as r}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";const s={title:'FF Рассказ "Медиатор"',description:"Миротворец — понятие растяжимое",date:"2025-09-02",categories:["story","flash fiction","writing"],published:!0,language:"ru"};var o=r(`<p>Ещё один день, полный сомнений и тревоги. Марта откинула волосы со лба и сильнее ссутулилась над аттестационным бланком академии кроссорбитальных медиаторов. После третьего отказа о поступлении можно забыть. Она сосредоточенно просмотрела работу и нетвёрдой рукой вложила планшет в ячейку считывания. Та загудела в унисон с дрожью внутри Марты. И тут мир взорвался.
...
— А главное, — сказал второй, — кроссорбитальный медиатор должен знать, когда быть медиатором, а когда — аннигилятором. Браво, Марта — вы приняты.</p>`);function d(t){var a=o();e(t,a)}export{d as default,s as metadata};
