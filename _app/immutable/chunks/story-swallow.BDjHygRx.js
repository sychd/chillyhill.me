import{a as e,t as r}from"./disclose-version.yxiXdSMO.js";import"./legacy.ELsv00tL.js";const s={title:'Рассказ "Ласточка"',description:"Месть это топливо. Или?",date:"2025-08-16",categories:["story","writing"],published:!0,language:"ru"};var o=r(`<p>В таверне пахло протухшей рыбой и скисшим элем, выплеснутым на горячие угли. Людей было немного: то тут, то там по углам сидели постоянные клиенты, уткнувшись лицом в стол. Трактирщик, меняя свечи, стоял на стремянке под потолком.
