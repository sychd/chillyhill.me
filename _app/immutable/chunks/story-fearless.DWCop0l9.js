import{a,t as r}from"./disclose-version.BheL1EAt.js";import"./legacy.DCSAwivz.js";import{S as n}from"./runtime.D0Eux3pY.js";const p={title:'Рассказ "Бесстрашный"',description:"Антивоенный рассказ",date:"2025-05-15",categories:["story","writing"],published:!1,language:"ru"};var s=r(`<h1>Бесстрашный</h1> <p>Двое людей в белых халатах стояли напротив широкого стола, за которым сидел не менее широкий, угрюмый человек.
...
— О, так это же еще и до конца квартала! Если все получится, то мне… А, впрочем вас это не касается. А если вы облажаетесь, то мне все равно — официально до начала следующего квартала вы не под моим руководством. — Командир распластался на стуле, мыслями витая где-то в своем, видимо, приятном мире будущих наград. — Можете быть свободны. Скоро все получите. Только дайте мне результат побыстрее.</p> <h3 style="text-align: center;">***</h3> На часах моргала семерка в окружении нулей. Полон нетерпения, Джереми достал из холодильника поддон с изумрудным, полупрозрачным стеклом. Поставил на стол, за которым уже сидел Джон и выжидающе смотрел. Он присел рядом и они вдвоем уставились в зеленоватое зеркало. Отражение химиков комичным образом переливалось в нем под светом лабораторных ламп.
...
— О да, они будут в в восторге, будь уверен. <h3 style="text-align: center;">***</h3> <p>Вечер наступил довольно скоро. Крупные шишки местного разлива, кому было интересно встретится по какому угодно поводу, чтобы потом этот повод бурно отметить, общались между собой в коридоре. Двое рядовых-добровольцев уже сидели в комнатке для испытаний.
...
— Хи-хи! — весело повторил ему лежащий рядом грузный мужчина с короткой прической ежиком, заложив руки за голову и подставив свое тело лучам рассветного солнца. — до трех месяцев… Они еще и не знают, что это — навсегда.`,1);function h(t){var e=s();n(13),a(t,e)}export{h as default,p as metadata};
