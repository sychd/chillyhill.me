---
title: Рассказ "Может, сегодня?"
description: Благими намерениями выстелена дорога в ад
date: '2025-12-03'
categories:
  - story
  - flash fiction
...
— Н-да, ты, конечно, такой ранимый… Сколько раз повторять: просто не обращай внимания! Я никогда от тебя не отстану.
— А я никогда не вернусь в вонючую клетку, — упрямо выдавливаю я, — лучше уж умереть.
— Именно! — Груда хохочет. — Смышлёный малый. И, в то же время, вредный и глуповат. Любящие получше знают, что тебе необходимо. И желают только добра, а ты… неблагодарный! И если этого не понимаешь, — мои внутренности скрутились адским рулетом, — лучше бы тебе и правда умереть. Может, сегодня?
